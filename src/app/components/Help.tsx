...
export default function Help() {
  ...
  //how to steps
  const steps = [
    { number: 1, title: 'Analyze real job postings', description: 'We collect and analyze job postings from major employers to understand what skills are in demand.'},

    { number: 2, title: 'Extract required skills', description: 'Identify the technical and soft skills that employers are actively seeking for each career path.'},

    { number: 3, title: 'Match skills to UMD courses', description: 'We connect those skills to specific courses offered at the University of Maryland across all departments.' },
  ...
  //FAQs
  const faqs = [
    { question: "Why don't I see a perfect match?", answer: "Job markets and academic programs don't always align perfectly. Many careers can be reached through multiple majors, and many majors lead to diverse career paths."},
    ...
    { question: "Where does the data come from?", answer: "We analyze job postings from sources like LinkedIn, Indeed, and Glassdoor through Jsearch API. Course and major information comes from UMD's official academic catalog using umd.io"}
  ];
